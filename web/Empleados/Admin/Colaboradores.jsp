                    ...
                    <div class="jumbotron">
                        <!-- Nav tabs --><div class="card">
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#1" style="color: white; background-color: #ababab"  aria-controls="home" role="tab" data-toggle="tab">Lista Colaboradores</a></li>
                                <li role="presentation"><a style="color: white; background-color: #ababab" href="#2" aria-controls="profile" role="tab" data-toggle="tab">Agregar Colaborador</a></li>
                                <li role="presentation"><a style="color: white; background-color: #ababab" href="#3" aria-controls="messages" role="tab" data-toggle="tab">Estadisticas</a></li>                                
                            </ul>
