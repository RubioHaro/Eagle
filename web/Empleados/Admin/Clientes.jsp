<%-- 
    Document   : Clientes
    Created on : 04-feb-2017, 2:40:21
    Author     : Rod
--%>
                        ...
                        <table id="table_id"  class="table">
                            ...
                            <tbody>
                                <%                                        
                                    ...
                                    TicketDeUsuarios ListaUsers = control.ObtenerListaDeClientes(50);
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <form method="POST" action="/Consultar">
                                            <button class="btn btn-default" name="IDCliente" value="<%out.println(ListaUsers.GetUser(i).getIdusuario());%>" type="submit">Ver Perfil</button>
                                        </form>
                                    </th>
                                </tr>
                                <%
