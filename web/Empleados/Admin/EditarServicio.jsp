<%-- 
    ...
    Author     : Rod; Hiram ; Emilio; Miguel
--%>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-right">
                                    <form method="post" action="/Edit" name="Edit">
                                        <button type="submit" onsubmit="ClickBorrarProducto()" onclick="ClickBorrarProducto()" name="Edit" value="<%out.println(prodct.getIdProcuto());%>" class="btn btn-lg btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Editar</button>
                                    </form>
                                </div>
