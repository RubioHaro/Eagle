                        ...
                        if (TamañoLista > 0) {
                            for (int i = 0; i < TamañoLista; ++i) {
                                ...
                                out.println(
                                        ...
                                        + "<td colspan='2' >" + DirInst.getDelegacion() + "</td>"
                            ...
                            out.println("<td colspan='7'>" + "No tienes servicios registrados, genera un servicio para ver el historial" + "</td>");
                        }
                    } catch (SQLException e) {
                        out.println("<td colspan='7'>Ha ocurrido un error: " + e.getMessage() + "</td>");
                    }
