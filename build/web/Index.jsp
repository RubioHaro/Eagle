...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Servicios de Transporte y Custodia" />	    
        <meta name="keywords" content="Transporte, Custodia, Seguridad">	
        <link rel="stylesheet" href="fancybox/jquery.fancybox-v=2.1.5.css" type="text/css" media="screen">
        <link rel="stylesheet" href="css/awesome.min.css" rel="stylesheet">	
        <link rel="stylesheet" type="text/css" href="css/IndexDesing.css">
